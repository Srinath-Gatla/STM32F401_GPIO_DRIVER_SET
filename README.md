...
This project implements a **custom bare-metal GPIO driver** for the STM32F401RE microcontroller using direct register-level programming. No HAL or CMSIS libraries are used — all peripheral control is handled through memory-mapped registers.

It also includes a **binary counter application** where 8 LEDs display incrementing values controlled by a push button.
...
1. GPIOB pins 0–7 are configured as output.  
2. GPIOA pin 0 is configured as input with pull-down.  
